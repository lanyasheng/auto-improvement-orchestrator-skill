...
<div style="font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif;font-size:13px;margin:20px 0">
<div style="border-radius:12px;padding:16px;background:#eff6ff;border:1px solid #93c5fd">
<div style="display:flex;gap:6px;align-items:center;flex-wrap:wrap">
<div style="background:#fff;border:1px solid #bfdbfe;border-radius:8px;padding:8px 12px;text-align:center"><b>generator</b><br/><span style="font-size:10px;color:#666">生成候选</span></div>
<div style="color:#999">→</div>
<div style="background:#fff;border:1px solid #bfdbfe;border-radius:8px;padding:8px 12px;text-align:center"><b>discriminator</b><br/><span style="font-size:10px;color:#666">4种打分</span></div>
<div style="color:#999">→</div>
<div style="background:#fff;border:1px solid #bfdbfe;border-radius:8px;padding:8px 12px;text-align:center"><b>evaluator</b><br/><span style="font-size:10px;color:#666">跑任务</span></div>
<div style="color:#999">→</div>
<div style="background:#fff;border:1px solid #bfdbfe;border-radius:8px;padding:8px 12px;text-align:center"><b>executor</b><br/><span style="font-size:10px;color:#666">应用+备份</span></div>
<div style="color:#999">→</div>
<div style="background:#fef2f2;border:1px solid #fca5a5;border-radius:8px;padding:8px 12px;text-align:center"><b style="color:#dc2626">gate</b><br/><span style="font-size:10px;color:#666">7层门禁</span></div>
...
<span style="background:#f0fdf4;border:1px solid #86efac;border-radius:6px;padding:3px 8px">✅ keep → 保留</span>
<span style="background:#fef2f2;border:1px solid #fca5a5;border-radius:6px;padding:3px 8px">↩️ revert → 提取 trace → 回 generator</span>
<span style="background:#fefce8;border:1px solid #fde68a;border-radius:6px;padding:3px 8px">⏸ pending → 人工审核</span>
<span style="background:#f8fafc;border:1px solid #e2e8f0;border-radius:6px;padding:3px 8px">❌ reject</span>
</div>
</div>
</div>
...
<div style="color:#999;font-size:10px">→</div>
<div style="background:#fefce8;border:1px solid #fde68a;border-radius:6px;padding:6px 10px;text-align:center;font-size:11px"><b>6</b> Doubt<br/><span style="font-size:9px;color:#666">投机语言</span></div>
<div style="color:#999;font-size:10px">→</div>
<div style="background:#fef2f2;border:1px solid #fca5a5;border-radius:6px;padding:6px 10px;text-align:center;font-size:11px"><b>7</b> Human<br/><span style="font-size:9px;color:#666">高风险审批</span></div>
</div>
<div style="font-size:11px;color:#666;margin-top:6px">任一层 fail = reject。Regression 容差按维度不同：security 2%、efficiency 10%、其他 5%</div>
</div>
...
<div style="font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif;font-size:13px;margin:20px 0">
<div style="border-radius:12px;padding:16px;background:#f0fdf4;border:1px solid #86efac">
<div style="font-size:11px;font-weight:700;color:#16a34a;margin-bottom:10px">📊 15 个 Skill 真实 LLM judge 评分（13/15 POWERFUL）</div>
<div style="display:flex;gap:3px;align-items:flex-end;height:80px">
<div style="flex:1;background:#16a34a;border-radius:3px 3px 0 0;height:95%" title="orchestrator 0.948"></div>
<div style="flex:1;background:#16a34a;border-radius:3px 3px 0 0;height:94%" title="executor 0.940"></div>
<div style="flex:1;background:#16a34a;border-radius:3px 3px 0 0;height:94%" title="evaluator 0.937"></div>
<div style="flex:1;background:#16a34a;border-radius:3px 3px 0 0;height:93%" title="gate 0.928"></div>
<div style="flex:1;background:#16a34a;border-radius:3px 3px 0 0;height:93%" title="feedback 0.928"></div>
<div style="flex:1;background:#16a34a;border-radius:3px 3px 0 0;height:92%" title="benchmark 0.919"></div>
<div style="flex:1;background:#16a34a;border-radius:3px 3px 0 0;height:92%" title="prompt 0.918"></div>
<div style="flex:1;background:#16a34a;border-radius:3px 3px 0 0;height:92%" title="autoloop 0.917"></div>
<div style="flex:1;background:#16a34a;border-radius:3px 3px 0 0;height:92%" title="generator 0.916"></div>
<div style="flex:1;background:#16a34a;border-radius:3px 3px 0 0;height:90%" title="distill 0.902"></div>
<div style="flex:1;background:#16a34a;border-radius:3px 3px 0 0;height:90%" title="discriminator 0.899"></div>
<div style="flex:1;background:#16a34a;border-radius:3px 3px 0 0;height:89%" title="harness 0.889"></div>
<div style="flex:1;background:#f59e0b;border-radius:3px 3px 0 0;height:89%" title="learner 0.885"></div>
</div>
<div style="display:flex;gap:3px;font-size:8px;color:#666;margin-top:2px">
<div style="flex:1;text-align:center">orch</div><div style="flex:1;text-align:center">exec</div><div style="flex:1;text-align:center">eval</div>
<div style="flex:1;text-align:center">gate</div><div style="flex:1;text-align:center">fb</div><div style="flex:1;text-align:center">bench</div>
<div style="flex:1;text-align:center">prom</div><div style="flex:1;text-align:center">auto</div><div style="flex:1;text-align:center">gen</div>
<div style="flex:1;text-align:center">dist</div><div style="flex:1;text-align:center">disc</div><div style="flex:1;text-align:center">harn</div>
<div style="flex:1;text-align:center">learn</div>
</div>
<div style="font-size:10px;color:#666;margin-top:6px">绿色 = POWERFUL (≥0.85) | 黄色 = SOLID (≥0.70) | 最高 orchestrator 0.948 | 最低 learner 0.885</div>
</div>
</div>
